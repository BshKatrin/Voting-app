...
class LiquidDemocracy:
    """Une classe qui contient la fonctionnalité nécessaire pour la démocratie liquide, i.e. faire les délégations."""
    ...
    def choose_possible_delegees(electors: List[Elector], delegator: Elector) -> List[Elector]:
        ...
        for elector in electors:
            ...
            if dist <= LiquidDemocracy.DELEGATION_GAP_COEF and elector.weight != 0:
