...
class Candidate(Person):
    """Une classe permettant de représenter un candidat dans une élection. Le couple (first_name, last_name) doit être unique."""
    ...
    """Des paramètres (moyenne, écart-type) pour générer le taux de dogmatisme."""
    ...
    """Un dictionnaire des scores pour chaque règle de vote utilisée lors de l'élection.
    ...
    def init_score(self, voting_rule: str, new_score: Union[int, float], list_type: Optional[bool] = False) -> None:
        ...
        Args:
            voting_rule (str): une règle de vote
    ...
    def add_score(self, voting_rule: str, score: Union[int, float]) -> None:
        ...
        Utilisée uniqument pour des règles de vote à 1 tour ou Condorcet-cohérent.

        Args:
            voting_rule (str): une règle de vote à 1 tour ou Condorcet-cohérent
    ...
    def add_score_round(self, voting_rule: str, score: Union[int, float], round: int) -> None:
        ...
        Utilisée uniquement pour des règles de vote à plusieurs tours.

        Args:
            voting_rule (str): une règle de vote à plusieurs tours
            score (Union[int, float]): un score à ajouter 
    ...
    def move_to_avg(self, positions: List[tuple[float, float]], travel_dist: float) -> None:
        ...
        Le taux de changement de la position est déterminée par `travel_dist`.
    ...
    def move_to_point(self, position_goal, travel_dist) -> None:
        """Change la position d'un candidat en s'approchant la position `position_goal`.
        Le taux de changement de la position est déterminée par `travel_dist`.
