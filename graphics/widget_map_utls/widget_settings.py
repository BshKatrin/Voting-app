...
class WidgetSettings(QWidget):
    ...
    def __init__(self, window_size, parent=None):
        ...
        side_size = min(window_size.width(), window_size.height())
        self.setFixedSize(0.6 * side_size, 0.6 * side_size)
    ...
    def initUI(self):
        self.economical_graph = GraphSettings(self, "Left-Right (economical)")
        self.social_graph = GraphSettings(self, "Liberal-Autoritarian (social)")
        self.knowledge_graph = GraphSettings(self, "Knowledge")
        self.coeffdir_graph = GraphSettings(self, "Coefficient directeur")

        self.initEconomalGraph()
        self.initSocialGraph()
        self.initAffineGraph()
        self.initKnowledgeGraph()
    ...
    def initSocialGraph(self):
        ...
        self.layout_social_widget.addWidget(self.social_graph, 1, 2)
        self.layout_social_widget.addWidget(self.mu_social_label, 2, 1)
        self.layout_social_widget.addWidget(self.slider_mu_socio, 2, 2)
        self.layout_social_widget.addWidget(self.mu_social_result, 2, 3)
        self.layout_social_widget.addWidget(self.sigma_social_label, 3, 1)
        self.layout_social_widget.addWidget(self.slider_sigma_socio, 3, 2)
        self.layout_social_widget.addWidget(self.sigma_social_result, 3, 3)
        self.widget_social = QWidget()
        self.widget_social.setFixedSize(400, 400)
        self.widget_social.setLayout(self.layout_social_widget)

    def initAffineGraph(self):
        ...
        self.layout_coeffdir_widget.addWidget(self.coeffdir_graph, 1, 2)
        self.layout_coeffdir_widget.addWidget(self.coeffdir_label, 2, 1)
        self.layout_coeffdir_widget.addWidget(self.slider_coeffdir, 2, 2)
        self.layout_coeffdir_widget.addWidget(self.coeffdir_result, 2, 3)
    ...
    def initKnowledgeGraph(self):
        ...
        self.layout_knowledge_widget.addWidget(self.knowledge_graph, 1, 2)
        self.layout_knowledge_widget.addWidget(self.mu_knowledge_label, 2, 1)
        self.layout_knowledge_widget.addWidget(self.slider_mu_knowledge, 2, 2)
        self.layout_knowledge_widget.addWidget(self.mu_knowledge_result, 2, 3)
        self.layout_knowledge_widget.addWidget(self.sigma_knowledge_label, 3, 1)
        self.layout_knowledge_widget.addWidget(self.slider_sigma_knowledge, 3, 2)
        self.layout_knowledge_widget.addWidget(self.sigma_knowledge_result, 3, 3)
    ...
    def majMuEcoValue(self, value):
        ...
        self.economical_graph.updateGraphGauss(
            self.election.economical_constants[0] / 560,
            self.election.economical_constants[1] / 560,
        )
    ...
    def majMuSocioValue(self, value):
        ...
        self.social_graph.updateGraphGauss(
            self.election.social_constants[0] / 560,
            self.election.social_constants[1] / 560,
        )
        self.coeffdir_graph.updateGraphAffine(
            self.election.coef_dir, (self.election.social_constants[0] - 280) / 560
        )
    ...
    def majMuKnowledgeValue(self, value):
        ...
        self.knowledge_graph.updateGraphGauss(
            self.election.knowledge_constants[0], self.election.knowledge_constants[1]
        )

    def majSigmaKnowledgeValue(self, value):
        self.election.knowledge_constants = (
            self.election.knowledge_constants[0],
            abs(self.election.knowledge_constants[0] - value / 100),
        )
